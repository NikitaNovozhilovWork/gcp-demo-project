...
function showMessage(message) {
    ...
    $("#chat").append("<tr id=" + message.id + " date=" + date.getTime() + "><td>" + message.userDisplayName + "</td><td>" + message.text + "</td><td>" + date.toLocaleString() + "</td></tr>");
}

function showHistory(message) {
    var date = new Date(message.sent);
    $("#chat").prepend("<tr id=" + message.id + " date=" + date.getTime() + "><td>" + message.userDisplayName + "</td><td>" + message.text + "</td><td>" + date.toLocaleString() + "</td></tr>");
}
